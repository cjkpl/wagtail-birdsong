from wagtail_modeladmin.options import hooks, modeladmin_register, ModelAdmin, ModelAdminGroup
...
def modeladmin_re_register(modeladmin_class):
    ...
    def unregister_menu_item(request, menu_items):
        if modeladmin_class.menu_item_name: # menu_item_name defined or inherited by modeladmin_class?
